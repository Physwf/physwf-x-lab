...
public:
	...
	*/
	 ...
	 */
	virtual void OnLevelAddedToWorld(FString InLevelName, UWorld* InWorld, bool bIsLightingScenario) {}
	 ...
	 */
	virtual X5_API TArray<FPrimitiveComponentId> GetScenePrimitiveComponentIds() const;
