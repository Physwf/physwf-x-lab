...
struct FViewMatrices
{
	...
	X5_API FViewMatrices(const FSceneViewInitOptions& InitOptions);
...
/** The uniform shader parameters for a mobile directional light and its shadow.
  ...
  */
BEGIN_UNIFORM_BUFFER_STRUCT_WITH_CONSTRUCTOR(FMobileDirectionalLightShaderParameters, X5_API)
...
BEGIN_UNIFORM_BUFFER_STRUCT_WITH_CONSTRUCTOR(FViewUniformShaderParameters, X5_API)
...
BEGIN_UNIFORM_BUFFER_STRUCT_WITH_CONSTRUCTOR(FInstancedViewUniformShaderParameters, X5_API)
	VIEW_UNIFORM_BUFFER_MEMBER_TABLE
 ...
 */
class X5_API ISceneViewFamilyScreenPercentage
{
protected:
	/**
