...
X0_API void DoTestCriticalStall();
extern X0_API int32 GTestCriticalStalls;
...
X0_API void LockFreeTagCounterHasOverflowed();
X0_API void LockFreeLinksExhausted(uint32 TotalNum);
X0_API void* LockFreeAllocLinks(SIZE_T AllocSize);
X0_API void LockFreeFreeLinks(SIZE_T AllocSize, void* Ptr);
...
struct FLockFreeLinkPolicy
{
	...
	X0_API static uint32 AllocLockFreeLink();
	X0_API static void FreeLockFreeLink(uint32 Item);
	X0_API static TAllocator LinkAllocator;
};
