...
public:
	 ...
	 */
	X0_API FDateTime(int32 Year, int32 Month, int32 Day, int32 Hour = 0, int32 Minute = 0, int32 Second = 0, int32 Millisecond = 0);
...
public:
	 ...
	 * @see ImportTextItem
	 */
	//X0_API bool ExportTextItem(FString& ValueStr, FDateTime const& DefaultValue, UObject* Parent, int32 PortFlags, UObject* ExportRootScope) const;
	 ...
	 */
	X0_API void GetDate(int32& OutYear, int32& OutMonth, int32& OutDay) const;
	 ...
	 */
	X0_API EDayOfWeek GetDayOfWeek() const;
	 ...
	 */
	X0_API int32 GetDayOfYear() const;
	 ...
	 * @return true on success, false otherwise.
	 */
	X0_API bool Serialize(FArchive& Ar);

	/**
	* Serializes this date and time for network transmission
	*/
	//X0_API bool NetSerialize(FArchive& Ar, class UPackageMap* Map, bool& bOutSuccess);
	 ...
	 */
	X0_API FString ToHttpDate() const;
	 ...
	 */
	X0_API FString ToIso8601() const;
	 ...
	 * @see Parse, ToIso8601
	 */
	X0_API FString ToString(const TCHAR* Format) const;
	 ...
	 */
	X0_API int64 ToUnixTimestamp() const
	{
...
public:
	 ...
	 * @see DaysInYear
	 */
	static X0_API int32 DaysInMonth(int32 Year, int32 Month);
	 ...
	 * @see DaysInMonth
	 */
	static X0_API int32 DaysInYear(int32 Year);
	 ...
	 */
	static X0_API bool IsLeapYear(int32 Year);
	 ...
	 */
	static X0_API bool Parse(const FString& DateTimeString, FDateTime& OutDateTime);
	 ...
	 */
	static X0_API bool ParseHttpDate(const FString& HttpDate, FDateTime& OutDateTime);
	 ...
	 */
	static X0_API bool ParseIso8601(const TCHAR* DateTimeString, FDateTime& OutDateTime);
	 ...
	 * @see Now
	 */
	static X0_API FDateTime UtcNow();
	 ...
	 */
	static X0_API bool Validate(int32 Year, int32 Month, int32 Day, int32 Hour, int32 Minute, int32 Second, int32 Millisecond);
...
public:
	 ...
	 * @return The archive.
	 */
// 	friend X0_API FArchive& operator<<(FArchive& Ar, FDateTime& DateTime)
// 	{
...
// 	}
	 ...
	 * @return Hash value.
	 */
	friend X0_API uint32 GetTypeHash(const FDateTime& DateTime)
	{
