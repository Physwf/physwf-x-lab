...
struct X0_API FOutputDeviceHelper
{
	/**
	...
	*/
	static FString FormatLogLine(ELogVerbosity::Type Verbosity, const class FString& Category, const TCHAR* Message = nullptr, ELogTimes::Type LogTime = ELogTimes::None, const double Time = -1.0);
	...
	**/
	static void FormatCastAndSerializeLine(class FArchive& Output, const TCHAR* Message, ELogVerbosity::Type Verbosity, const class FString& Category, const double Time, bool bSuppressEventTag, bool bAutoEmitLineTerminator);
};
