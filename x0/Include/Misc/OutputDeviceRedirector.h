...
struct FBufferedLine
{
	...
	FBufferedLine(const TCHAR* InData, const class FString& InCategory, ELogVerbosity::Type InVerbosity, const double InTime = -1)
		: Data(InData)
		, Category(InCategory)
		, Time(InTime)
...
*/
class X0_API FOutputDeviceRedirector : public FOutputDevice
{
private:
