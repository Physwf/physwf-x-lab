...
public:
	...
	static inline bool IsUper(CharType Char);
	...
	static inline IsUnderscore(CharType Char) { return Char == LITERAL(CharType, '_'); }
public:
	static inline IsLineBreak(CharType Char) { return LineBreakImplementation<CharType, sizeof(CharType)>::IsLinebreak(Char); }
};

typedef TChar<TCHAR> XCHar;
typedef TChar<WIDECHAR> XWideChar;
typedef TChar<ANSICHAR> XCharAnsi;
