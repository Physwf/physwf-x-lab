...
public:
	 ...
	 * @see ImportTextItem
	 */
	//X0_API bool ExportTextItem(FString& ValueStr, FGuid const& DefaultValue, UObject* Parent, int32 PortFlags, class UObject* ExportRootScope) const;
	 ...
	 * @return The string representation.
	 */
	X0_API FString ToString(EGuidFormats Format) const;
...
public:
	 ...
	 * @see Parse, ToString
	 */
	//static X0_API bool ParseExact(const FString& GuidString, EGuidFormats Format, FGuid& OutGuid);
