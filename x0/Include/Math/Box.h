...
public:
	 ...
	 */
	X0_API FBox(const FVector* Points, int32 Count);
	 ...
	 * @param Points Array of Points to create for the bounding volume.
	 */
	X0_API FBox(const TArray<FVector>& Points);
...
public:
	...
	*/
	 ...
	 */
	X0_API FBox Overlap(const FBox& Other) const;
	...
	/**
	  ...
	  */
	X0_API FBox InverseTransformBy(const FTransform& M) const;
	 ...
	 */
	X0_API FBox TransformBy(const FMatrix& M) const;
	 ...
	 * @see TransformProjectBy
	 */
	X0_API FBox TransformBy(const FTransform& M) const;
	 ...
	 * @see TransformBy
	 */
	X0_API FBox TransformProjectBy(const FMatrix& ProjM) const;
