...
public:
	...
	static X0_API FMatrix MakeFromXY(FVector const& XAxis, FVector const& YAxis);
	...
	static X0_API FMatrix MakeFromXZ(FVector const& XAxis, FVector const& ZAxis);
	...
	static X0_API FMatrix MakeFromYX(FVector const& YAxis, FVector const& XAxis);
	...
	static X0_API FMatrix MakeFromYZ(FVector const& YAxis, FVector const& ZAxis);
	...
	static X0_API FMatrix MakeFromZX(FVector const& ZAxis, FVector const& XAxis);
	...
	static X0_API FMatrix MakeFromZY(FVector const& ZAxis, FVector const& YAxis);
};
