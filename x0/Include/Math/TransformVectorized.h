...
public:
	 ...
	 */
	static X0_API const FTransform Identity;
	...
	*/
	 ...
	 *******************************************************************************************/
	X0_API FTransform GetRelativeTransform(const FTransform& Other) const;
	X0_API FTransform GetRelativeTransformReverse(const FTransform& Other) const;
	/**
	 ...
	 */
	X0_API void		SetToRelativeTransform(const FTransform& ParentTransform);
