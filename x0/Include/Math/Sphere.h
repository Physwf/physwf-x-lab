...
public:
	 ...
	 */
	X0_API FSphere(const FVector* Pts, int32 Count);
...
public:
	...
	*/
	 ...
	 */
	X0_API FSphere TransformBy(const FMatrix& M) const;
	 ...
	 * @return Result of transformation.
	 */
	X0_API FSphere TransformBy(const FTransform& M) const;
	 ...
	 */
	X0_API FSphere& operator+=(const FSphere& Other);
