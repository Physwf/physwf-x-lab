...
struct X0_API FWindowsPlatformAtomics
	: public FGenericPlatformAtomics
{
	...
	static inline int64 InterlockedExchange(volatile int64* Value, int64 Exchange)
	{
#if PLATFORM_64BITS
	...
	static inline int8 InterlockedCompareExchange(volatile int8* Dest, int8 Exchange, int8 Comparand)
	{
		return (int8)::_InterlockedCompareExchange8((char*)Dest, (char)Exchange, (char)Comparand);
	}

	static inline int16 InterlockedCompareExchange(volatile int16* Dest, int16 Exchange, int16 Comparand)
	{
		return (int16)::_InterlockedCompareExchange16((short*)Dest, (short)Exchange, (short)Comparand);
	}

	static inline int32 InterlockedCompareExchange(volatile int32* Dest, int32 Exchange, int32 Comparand)
	{
		return (int32)::_InterlockedCompareExchange((long*)Dest, (long)Exchange, (long)Comparand);
	}

	static inline int64 InterlockedCompareExchange(volatile int64* Dest, int64 Exchange, int64 Comparand)
	{
#if !(UE_BUILD_SHIPPING || UE_BUILD_TEST)
		if (IsAligned(Dest) == false)
		{
	...
	static inline int8 AtomicRead(volatile const int8* Src)
	{
		return InterlockedCompareExchange((int8*)Src, 0, 0);
	}

	static inline int16 AtomicRead(volatile const int16* Src)
	{
		return InterlockedCompareExchange((int16*)Src, 0, 0);
	}

	static inline int32 AtomicRead(volatile const int32* Src)
	{
		return InterlockedCompareExchange((int32*)Src, 0, 0);
	}

	static inline int64 AtomicRead(volatile const int64* Src)
	{
		return InterlockedCompareExchange((int64*)Src, 0, 0);
	}

	static inline int8 AtomicRead_Relaxed(volatile const int8* Src)
	{
		return *Src;
	}

	static inline int16 AtomicRead_Relaxed(volatile const int16* Src)
	{
		return *Src;
	}

	static inline int32 AtomicRead_Relaxed(volatile const int32* Src)
	{
		return *Src;
	}

	static inline int64 AtomicRead_Relaxed(volatile const int64* Src)
	{
#if PLATFORM_64BITS
		return *Src;
#else
	...
	static inline void AtomicStore(volatile int8* Src, int8 Val)
	{
		InterlockedExchange(Src, Val);
	}

	static inline void AtomicStore(volatile int16* Src, int16 Val)
	{
		InterlockedExchange(Src, Val);
	}

	static inline void AtomicStore(volatile int32* Src, int32 Val)
	{
		InterlockedExchange(Src, Val);
	}

	static inline void AtomicStore(volatile int64* Src, int64 Val)
	{
		InterlockedExchange(Src, Val);
	}

	static inline void AtomicStore_Relaxed(volatile int8* Src, int8 Val)
	{
		*Src = Val;
	}

	static inline void AtomicStore_Relaxed(volatile int16* Src, int16 Val)
	{
		*Src = Val;
	}

	static inline void AtomicStore_Relaxed(volatile int32* Src, int32 Val)
	{
		*Src = Val;
	}

	static inline void AtomicStore_Relaxed(volatile int64* Src, int64 Val)
	{
#if PLATFORM_64BITS
		*Src = Val;
#else
	...
	// 		static inline int64 AtomicRead64(volatile const int64* Src)
	// 	{
