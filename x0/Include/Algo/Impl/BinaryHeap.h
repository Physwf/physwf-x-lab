...
namespace AlgoImpl
{
	...
	*/
	inline int32 HeapGetLeftChildIndex(int32 Index)
	{
		return Index * 2 + 1;
	}
	...
	*/
	inline bool HeapIsLeaf(int32 Index, int32 Count)
	{
	...
	*/
	inline int32 HeapGetParentIndex(int32 Index)
	{
		return (Index - 1) / 2;
	}
	...
	*/
	...
	inline void HeapSiftDown(RangeValueType* Heap, int32 Index, const int32 Count, const ProjectionType& Projection, const PredicateType& Predicate)
	{
	...
	*/
	...
	inline int32 HeapSiftUp(RangeValueType* Heap, int32 RootIndex, int32 NodeIndex, const ProjectionType& Projection, const PredicateType& Predicate)
	{
	...
	*/
	template <typename RangeValueType, typename ProjectionType, typename PredicateType>
	inline void HeapifyInternal(RangeValueType* First, SIZE_T Num, ProjectionType Projection, PredicateType Predicate)
	{
