...
namespace Algo
{
	...
	*/
	...
	inline void Heapify(RangeType& Range)
	{
	...
	*/
	...
	inline void Heapify(RangeType& Range, PredicateType Predicate)
	{
	...
	*/
	...
	inline void HeapifyBy(RangeType& Range, ProjectionType Projection)
	{
	...
	*/
	template <typename RangeType, typename ProjectionType, typename PredicateType>
	inline void HeapifyBy(RangeType& Range, ProjectionType Projection, PredicateType Predicate)
	{
