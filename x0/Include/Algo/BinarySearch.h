...
namespace AlgoImpl
{
	...
	*/
	...
	inline SIZE_T LowerBoundInternal(RangeValueType* First, const SIZE_T Num, const PredicateValueType& Value, ProjectionType Projection, SortPredicateType SortPredicate)
	{
	...
	*/
	template <typename RangeValueType, typename PredicateValueType, typename ProjectionType, typename SortPredicateType>
	inline SIZE_T UpperBoundInternal(RangeValueType* First, const SIZE_T Num, const PredicateValueType& Value, ProjectionType Projection, SortPredicateType SortPredicate)
	{
		// Current start of sequence to check
		SIZE_T Start = 0;
		// Size of sequence to check
...
namespace Algo
{
	...
	*/
	...
	inline int32 LowerBound(RangeType& Range, const ValueType& Value, SortPredicateType SortPredicate)
	{
	...
	*/
	...
	inline int32 LowerBoundBy(RangeType& Range, const ValueType& Value, ProjectionType Projection, SortPredicateType SortPredicate)
	{
	...
	*/
	template <typename RangeType, typename ValueType, typename SortPredicateType>
	inline int32 UpperBound(RangeType& Range, const ValueType& Value, SortPredicateType SortPredicate)
	{
	...
	*/
	template <typename RangeType, typename ValueType, typename ProjectionType, typename SortPredicateType>
	inline int32 UpperBoundBy(RangeType& Range, const ValueType& Value, ProjectionType Projection, SortPredicateType SortPredicate)
	{
	...
	*/
	template <typename RangeType, typename ValueType, typename SortPredicateType>
	inline int32 BinarySearch(RangeType& Range, const ValueType& Value, SortPredicateType SortPredicate)
	{
	...
	*/
	template <typename RangeType, typename ValueType, typename ProjectionType, typename SortPredicateType>
	inline int32 BinarySearchBy(RangeType& Range, const ValueType& Value, ProjectionType Projection, SortPredicateType SortPredicate)
	{
