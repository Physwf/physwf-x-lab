...
#else
inline void DoGamethreadHook(int32 Index)
{
}
#endif
...
struct CORE_API FScopedMallocTimer
{
	...
	inline FScopedMallocTimer(int32 InIndex)
		: Index(InIndex)
	...
	static inline void Miss(int32 InIndex)
	{
...
struct X0_API FMemory
{
	...
	static inline int32 Memcmp(const void* Buff1, const void* Buff2, SIZE_T Count)
	{
		return FPlatformMemory::Memcmp(Buff1, Buff2, Count);
	}
