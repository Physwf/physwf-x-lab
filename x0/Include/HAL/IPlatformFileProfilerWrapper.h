...
class X0_API FProfiledPlatformFile : public IPlatformFile
{
protected:
...
public:
	...
	{
		return /*FParse::Param(CmdLine, GetName())*/false;
	}
...
class X0_API FPlatformFileReadStats : public IPlatformFile
{
protected:
