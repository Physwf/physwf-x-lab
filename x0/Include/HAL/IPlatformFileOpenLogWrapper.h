...
class X0_API FPlatformFileOpenLog : public IPlatformFile
{
protected:
...
public:
	...
	{
		bool bResult = false/*FParse::Param(CmdLine, TEXT("FileOpenLog"))*/;
		return bResult;
	}
	...
	virtual bool Initialize(IPlatformFile* Inner, const TCHAR* CommandLineParam) override
	{
		...
		if (0/*FParse::Value(CommandLineParam, TEXT("TARGETPLATFORM="), PlatformStr)*/)
		{
