 ...
 */
struct X0_API FGenericPlatformMemoryStats : public FPlatformMemoryConstants
{
...
struct X0_API FGenericPlatformMemory
{
	...
	*/
	...
	private:
		...
		public:
			...
			*/
			static inline bool SupportsFastVRAMMemory()
			{
				return false;
			}
			...
			*/
			inline static void OnLowLevelMemory_Alloc(void const* Pointer, uint64 Size, uint64 Tag) { }
			inline static void OnLowLevelMemory_Free(void const* Pointer, uint64 Size, uint64 Tag) { }
