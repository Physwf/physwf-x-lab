...
void FMsg::LogfImpl(const ANSICHAR* File, int32 Line, const FString& Category, ELogVerbosity::Type Verbosity, const TCHAR* Fmt, ...)
{
#if !NO_LOGGING
...
void FMsg::Logf_InternalImpl(const ANSICHAR* File, int32 Line, const FString& Category, ELogVerbosity::Type Verbosity, const TCHAR* Fmt, ...)
{
#if !NO_LOGGING
	if (Verbosity != ELogVerbosity::Fatal)
	{
