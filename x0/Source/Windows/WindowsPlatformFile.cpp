...
*/
class X0_API FAsyncBufferedFileReaderWindows : public IFileHandle
{
protected:
...
class X0_API FFileHandleWindows : public IFileHandle
{
...
**/
class X0_API FWindowsPlatformFile : public IPhysicalPlatformFile
{
protected:
