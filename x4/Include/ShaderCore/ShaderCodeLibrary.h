...
struct X4_API FShaderCodeLibraryPipeline
{
...
struct X4_API FCompactFullName
{
	TArray<FString> ObjectClassAndPath;
...
struct X4_API FStableShaderKeyAndValue
{
	...
	FString TargetFrequency;
	FString TargetPlatform;
	FString VFType;
	FString PermutationId;
...
struct X4_API FShaderCodeLibrary
{
