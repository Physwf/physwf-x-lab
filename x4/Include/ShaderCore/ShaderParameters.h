...
X4_API void CacheUniformBufferIncludes(TMap<const TCHAR*, struct FCachedUniformBufferDeclaration>& Cache, EShaderPlatform Platform);
...
public:
	...
	X4_API void Bind(const FShaderParameterMap& ParameterMap, const TCHAR* ParameterName, EShaderParameterFlags Flags = SPF_Optional);
	//friend X4_API FArchive& operator<<(FArchive& Ar, FShaderParameter& P);
...
public:
	...
	X4_API void Bind(const FShaderParameterMap& ParameterMap, const TCHAR* ParameterName, EShaderParameterFlags Flags = SPF_Optional);
	//friend X4_API FArchive& operator<<(FArchive& Ar, FShaderResourceParameter& P);
...
extern X4_API void CreateUniformBufferShaderDeclaration(const TCHAR* Name, const FUniformBufferStruct& UniformBufferStruct, FString& OutDeclaration);
...
public:
	...
	static X4_API void ModifyCompilationEnvironment(const TCHAR* ParameterName, const FUniformBufferStruct& Struct, EShaderPlatform Platform, FShaderCompilerEnvironment& OutEnvironment);
