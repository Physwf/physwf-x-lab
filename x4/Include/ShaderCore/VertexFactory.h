...
*/
class X4_API FVertexFactoryShaderParameters
{
public:
...
public:
	...
	*/
	static X4_API TLinkedList<FVertexFactoryType*>*& GetTypeList();

	/**
	* Finds a FVertexFactoryType by name.
	*/
	static X4_API FVertexFactoryType* GetVFByName(const FString& VFName);
	...
	*/
	...
	X4_API virtual ~FVertexFactoryType();

	// Accessors.
	const TCHAR* GetName() const { return Name; }
	FString GetFName() const { return TypeName; }
	...
	X4_API const FSHAHash& GetSourceHash() const;
	...
	*/
	...
	X4_API void AddReferencedUniformBufferIncludes(FShaderCompilerEnvironment& OutEnvironment, FString& OutSourceFilePrefix, EShaderPlatform Platform);
...
private:
	static X4_API uint32 NextHashIndex;
...
*/
//extern X4_API FArchive& operator<<(FArchive& Ar, FVertexFactoryType*& TypeRef);
...
*/
extern X4_API FVertexFactoryType* FindVertexFactoryType(FString TypeName);
...
*/
class X4_API FVertexFactory : public FRenderResource
{
public:
...
*/
class X4_API FVertexFactoryParameterRef
{
public:
	...
	//friend X4_API bool operator<<(FArchive& Ar, FVertexFactoryParameterRef& Ref);
