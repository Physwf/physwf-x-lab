...
struct X4_API FShaderTextureKey
{
	mutable uint32 Hash;
	uint32 X;
	uint32 Y;
...
struct X4_API FShaderResourceKey
{
...
struct X4_API FShaderRenderTargetKey
{
...
struct X4_API FShaderCacheRasterizerState
{
...
struct X4_API FShaderPipelineKey
{
...
struct X4_API FShaderCacheGraphicsPipelineState
{
...
struct X4_API FShaderCodeCache
{
