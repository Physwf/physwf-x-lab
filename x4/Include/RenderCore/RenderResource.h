...
* This is called in the game thread.
*/
extern X4_API void StartBatchedRelease();

/**
* Disables the batching of calls to BeginReleaseResource
* This is called in the game thread.
*/
extern X4_API void EndBatchedRelease();
...
extern X4_API float GEnableMipLevelFading;

/** Global mip fading settings, indexed by EMipFadeSettings. */
extern X4_API FMipFadeSettings GMipFadeSettings[MipFade_NumSettings];
...
struct FMipBiasFade
{
	 ...
	 */
	X4_API void	SetNewMipCount(float ActualMipCount, float TargetMipCount, double LastRenderTime, EMipFadeSettings FadeSetting);
 ...
 */
class X4_API FGlobalDynamicVertexBuffer
{
public:
	/**
 ...
 */
class X4_API FGlobalDynamicIndexBuffer
{
public:
	/**
	 * Information regarding an allocation from this buffer.
