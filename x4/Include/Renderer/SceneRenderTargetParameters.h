...
BEGIN_UNIFORM_BUFFER_STRUCT(FSceneTexturesUniformParameters, X4_API)
	// Scene Color / Depth
...
extern X4_API void SetupSceneTextureUniformParameters(
...
X4_API TUniformBufferRef<FSceneTexturesUniformParameters> CreateSceneTextureUniformBufferSingleDraw(TRHICmdList& RHICmdList, ESceneTextureSetupMode SceneTextureSetupMode, ERHIFeatureLevel::Type FeatureLevel);

BEGIN_UNIFORM_BUFFER_STRUCT(FMobileSceneTextureUniformParameters, X4_API)
	UNIFORM_MEMBER_TEXTURE(Texture2D, SceneColorTexture)
	UNIFORM_MEMBER_SAMPLER(SamplerState, SceneColorTextureSampler)
	UNIFORM_MEMBER_TEXTURE(Texture2D, SceneDepthTexture)
	UNIFORM_MEMBER_SAMPLER(SamplerState, SceneDepthTextureSampler)
...
template< typename TRHICmdList >
X4_API TUniformBufferRef<FMobileSceneTextureUniformParameters> CreateMobileSceneTextureUniformBufferSingleDraw(TRHICmdList& RHICmdList, ERHIFeatureLevel::Type FeatureLevel);

extern X4_API void BindSceneTextureUniformBufferDependentOnShadingPath(
...
class X4_API FSceneTextureShaderParameters
{
public:
