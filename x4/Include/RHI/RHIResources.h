...
class X4_API FRHITexture2D : public FRHITexture
{
public:
	/** Initialization constructor. */
...
class X4_API FRHITexture2DArray : public FRHITexture
{
public:
...
class X4_API FRHITexture3D : public FRHITexture
{
public:
...
class X4_API FRHITextureCube : public FRHITexture
{
public:
...
class X4_API FRHITextureReference : public FRHITexture
{
public:
...
class X4_API FRHITextureReferenceNullImpl : public FRHITextureReference
{
public:
...
{
public:
	FRHIComputeFence(FString InName)
		: Name(InName)
...
struct FRHIRenderPassInfo
{
	...
	X4_API void Validate() const;
	X4_API void ConvertToRenderTargetsInfo(FRHISetRenderTargetsInfo& OutRTInfo) const;
