...
extern X4_API bool GIsRunningRHIInDedicatedThread_InternalUseOnly;
extern X4_API bool GIsRunningRHIInTaskThread_InternalUseOnly;

/** private accumulator for the RHI thread. */
extern X4_API uint32 GWorkingRHIThreadTime;
extern X4_API uint32 GWorkingRHIThreadStallTime;
...
struct  FRHICommandBeginUpdateMultiFrameResource final : public FRHICommand<FRHICommandBeginUpdateMultiFrameResource>
{
	...
	X4_API void Execute(FRHICommandListBase& CmdList);
};
...
class X4_API FRHICommandList : public FRHICommandListBase
{
public:
	...
	FORCEINLINE_DEBUGGABLE void SetComputePipelineState(class FComputePipelineState* ComputePipelineState)
	{
		if (Bypass())
		{
			extern X4_API FRHIComputePipelineState* ExecuteSetComputePipelineState(class FComputePipelineState* ComputePipelineState);
	...
	FORCEINLINE_DEBUGGABLE void SetGraphicsPipelineState(class FGraphicsPipelineState* GraphicsPipelineState)
	{
		...
		if (Bypass())
		{
			extern X4_API FRHIGraphicsPipelineState* ExecuteSetGraphicsPipelineState(class FGraphicsPipelineState* GraphicsPipelineState);
...
class X4_API FRHIAsyncComputeCommandList : public FRHICommandListBase
{
public:
...
class X4_API FRHICommandListImmediate : public FRHICommandList
{
...
class X4_API FRHIAsyncComputeCommandListImmediate : public FRHIAsyncComputeCommandList
{
public:
...
class X4_API FRHICommandListExecutor
{
public:
	enum
	{
...
extern X4_API FRHICommandListExecutor GRHICommandList;

//extern X4_API FAutoConsoleTaskPriority CPrio_SceneRenderingTask;
...
struct FScopedCommandListWaitForTasks
{
	...
	X4_API ~FScopedCommandListWaitForTasks();
};
