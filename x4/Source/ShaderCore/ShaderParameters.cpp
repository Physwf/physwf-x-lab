...
X4_API void CreateUniformBufferShaderDeclaration(const TCHAR* Name, const FUniformBufferStruct& UniformBufferStruct, FString& OutDeclaration)
{
	OutDeclaration = CreateHLSLUniformBufferDeclaration(Name, UniformBufferStruct);
}

X4_API void CacheUniformBufferIncludes(TMap<const TCHAR*, FCachedUniformBufferDeclaration>& Cache)
{
