...
// 			});
	...
	int32 EvictionPeriod = 60;// CVarPSOEvictionTime.GetValueOnAnyThread();
...
{
	return /*GCVarAsyncPipelineCompile.GetValueOnAnyThread()*/ 1 && !RHICmdList.Bypass() && IsRunningRHIInSeparateThread();
}
