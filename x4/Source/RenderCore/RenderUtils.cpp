...
X4_API FTexture* GMipColorTexture = new FMipColorTexture;
X4_API int32 GMipColorTextureMipLevels = FMipColorTexture::NumMips;

// 4: 8x8 cubemap resolution, shader needs to use the same value as preprocessing
X4_API const uint32 GDiffuseConvolveMipLevel = 4;
...
X4_API int32 bUseForwardShading = 0;
